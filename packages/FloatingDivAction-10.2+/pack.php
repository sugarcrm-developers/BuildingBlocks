#!/usr/bin/env php
<?php
// Copyright 2021 SugarCRM Inc.  Licensed by SugarCRM under the Apache 2.0 license.


 $packageID = "BuildingBlock_FloatingDivExample_10_2+";
 $packageLabel = "Floating Div Example for 10.2+";
 $supportedVersionRegex = '10\\.(2|3)\\..*$';
/******************************/
