...
$packageID = "BuildingBlock_SugarBPM_CapitalizeRecordNameAction";
$packageLabel = "BuildingBlocks: SugarBPM Capitalize Record Name Action";
$supportedVersionRegex = '(26|25|14)\\..*$';
$acceptableSugarFlavors = array('ENT');
$description = 'Add new [Capitalize Record Name] Action to the SugarBPM actions.';
/******************************/
