...
$packageID = "BuildingBlock_SugarBPM_Dashlet";
$packageLabel = "BuildingBlocks: SugarBPM Process Management Dashlet";
$supportedVersionRegex = '(26|25|14)\\..*$';
$acceptableSugarFlavors = array('ENT');
$description = 'Dashlet that shows processes associated with the current module/records.';
/******************************/
