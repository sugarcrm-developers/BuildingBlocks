...
// note you will likely have to change the path to point to a directory on your server that is housing Wordpress
...
function init_scripts() {
	...
	// this will add a javascript object that contains the current wordpress base url that we can access on the front-end
	wp_localize_script('sugarcrm-api-scripts', 'SugarCRM', array(
